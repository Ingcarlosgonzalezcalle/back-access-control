...
const getList = async (body, res) => {
  try {
    ...
    const worksheet = workbook.addWorksheet('Movements');
      ...
      mesa_votacion: capitalizeWords(row.mesa_votacion),
    ...
    worksheet.columns = [
      ...
      { header: 'Departamento votación', key: 'departamento_votacion', width: 18 },
      { header: 'Municipio votación', key: 'municipio_votacion', width: 22 },
      { header: 'Puesto votación', key: 'puesto_votacion', width: 35 },
      { header: 'mesa votación', key: 'mesa_votacion', width: 18 },
      { header: 'Direccion Puesto', key: 'direccion_votacion', width: 40 }
    ];
